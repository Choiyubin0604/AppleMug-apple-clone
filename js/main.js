(()=>{
    ...
    function setLayout() {
        ...
        let toalScrollHeight = 0;
        for(let i = 0; i < sceneInfo.length; i++) {
            toalScrollHeight = toalScrollHeight + sceneInfo[i].scrollHeight;
            if(toalScrollHeight >= yOffset) {
                currentScene = i;
                break;
            }
        }
    ...
    function calcValues(values, currentYOffset) {
        //currentYOffset - 현재 씬에서 얼마나 스크롤 했는지
        let rv;
    ...
    function playAnimation() {
        ...
        switch (currentScene) {
            ...
            case 3:
                ...
                // 좌우 whiteRect 그리기 fillRect(x, y, width, height)
